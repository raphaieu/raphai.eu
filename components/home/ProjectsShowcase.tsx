  ...
  const projects: Project[] = [
    {
      ...
      status: t('status.mvp'),
      tags: ['Laravel 12', 'Next.js', 'Vue 3', 'Laravel Reverb', 'NeuronAI', 'Node.js', 'Puppeteer', 'MQL5', 'PostgreSQL', 'Redis', 'Stripe', 'Docker', 'GitHub Actions'],
      featured: false,
    ...
    },
    {
      ...
      tags: ['Laravel 12', 'Laravel Filament', 'Vue 3', 'Inertia.js', 'Tailwind CSS', 'MySQL', 'Redis', 'Stripe', 'WhatsApp (EvolutionAPI)', 'Docker'],
      featured: false,
    ...
    },
    {
      ...
      status: t('status.production'),
      tags: ['Hono', 'TypeScript', 'Vercel', 'Turso DB', 'Clerk Auth', 'Google Places', 'Mercado Pago', 'OpenAI'],
      featured: false,
    ...
    },
    {
      ...
      status: t('status.production'),
      tags: ['Laravel', 'Nuxt 3', 'TailwindCSS', 'Instagram Graph API', 'SSR', 'Docker'],
      featured: false,
